...
with open('object_network.csv', 'w', newline='') as csvfile:
    ...
    lofl = []
    lofl.append(['Name','Host','Description','Interface'])
    for i in o_network:
        ...
        for r in clean:
            ...
            if re.match('network-object\shost.+', r): # network-object host x
                ...
                if ipam == "":
                    ...
                    try:
                        ipam = [k + '|' + v for k,v in data_ipam.items() if r.split(' ')[2].lower() in v.lower()][0]
                    except:
                        pass
            ...
            if re.match('network-object\sobject.+', r): # network-object object x
                addr = ""
                if r.split(' ')[2] in objNetwork:
                    addr = objNetwork[r.split(' ')[2]]
